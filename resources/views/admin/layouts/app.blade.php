        ...
        <div class="sideMenu bg-mattBlackLight">
            <div class="sidebar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">المستخدمين</span></a></li>
                    <li class="nav-item"><a href="#" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">المديرين</span></a></li>
                    {{--<li class="nav-item"><a href="#" class="nav-link px-2"><i class="material-icons icon">account_circle</i><span class="text">إعدادات الموقع</span></a></li>--}}
