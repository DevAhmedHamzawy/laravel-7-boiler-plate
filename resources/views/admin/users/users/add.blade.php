            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        @include('admin.users.includes.create.common')


                        <div class="form-group row">
                            <label for="role" class="col-md-2 col-form-label text-md-right">الدور</label>

                            <div class="col-md-10">
                                <select name="role" id="role" class="form-control @error('role') is-invalid @enderror" required>
                                    <option selected disabled>اختر الدور</option>
                                    <option value="8">مستخدم</option>
                                    <option value="1">وكالة عقارية</option>
                                </select>
                        ...
                        @include('admin.users.includes.create.office')
